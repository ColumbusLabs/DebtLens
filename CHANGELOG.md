...
- **Expanded MCP workflow tools** for adoption dry runs, report comparison, suppression
  directive generation, and read-only baseline diff/prune previews with structured
  content for agent planning ([#184](https://github.com/ColumbusLabs/DebtLens/issues/184)).
