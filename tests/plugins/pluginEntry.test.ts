...
import { DEBTLENS_PLUGIN_API_VERSION, SUPPORTED_SOURCE_LANGUAGES } from "../../src/plugin.js";
import type { DebtIssue, Detector, DetectorContext, Severity, SourceLanguage } from "../../src/plugin.js";
...
describe("debtlens/plugin entry point", () => {
  ...
  it("exports registered source languages for plugin authors", () => {
    assert.deepEqual(SUPPORTED_SOURCE_LANGUAGES, ["tsjs", "python", "kotlin", "swift", "ruby", "vue", "svelte"]);
  });
  ...
  it("exposes the detector contract types", () => {
    ...
    const language: SourceLanguage = "tsjs";
